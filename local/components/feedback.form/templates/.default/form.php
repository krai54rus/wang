...
<div id="afbf_name_fid1" class="afbf_item_pole required">
					<div class="afbf_name">
Ваше имя <span class="afbf_required_text">*</span>						<div class="afbf_hint"></div>
					</div>
					<div class="afbf_inputtext_bg" id="error_NAME_<?=$ALX?>">
							<input type="text" size="40" id="NAME_<?=$ALX?>" name="FIELDS[NAME_<?=$ALX?>]" value="" class="afbf_inputtext" onblur="if(this.value==''){this.value=''}" onclick="if(this.value==''){this.value=''}">
