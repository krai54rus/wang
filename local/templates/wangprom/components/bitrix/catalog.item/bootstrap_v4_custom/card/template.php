...
<div class="product-item">
    <a href="javascript:;" data-fancybox  data-type="ajax" data-src="<?=SITE_TEMPLATE_PATH?>/quick_view.php?ID=<?=$item["ID"]?>&SECTION_ID=<?=$item["IBLOCK_SECTION_ID"]?>" class="modalbox">
    <? if ($itemHasDetailUrl): ?>
	<div class="product-item-image-wrapper" title="<?=$imgTitle?>"
			...
			switch ($blockName)
			{
				...
				case 'quantityLimit':
					if ($arParams['SHOW_MAX_QUANTITY'] !== 'N')
					{
						...
						else
						{
							...
							{
								?>
								<div class="product-item-info-container product-item-price-container" id="<?=$itemIds['QUANTITY_LIMIT']?>">
									<div class="product-item-info-container-title text-muted">
										<?=$arParams['MESS_SHOW_MAX_QUANTITY']?>:
				...
				case 'quantity':
                    if (!$haveOffers)
                    {
                        ...
                        {
                            ?>
                            <div class="product-item-info-container product-item-price-container" data-entity="quantity-block">
				...
				case 'buttons':
					?>
                    <div class="product-item-info-container product-item-price-container" data-entity="buttons-block">
                        <?
                        if (!$haveOffers)
                        {
                            if ($actualItem['CAN_BUY'])
                            {
                                ...
                                <div class="product-item-button-container" id="<?=$itemIds['BASKET_ACTIONS']?>">
                                    <button class="item-btn-buy" id="<?=$itemIds['BUY_LINK']?>"
				...
				case 'props':
					if (!$haveOffers)
					{
						...
						{
							?>
							<div class="product-item-info-container product-item-price-container" data-entity="props-block">
				...
				case 'sku':
					...
					{
						?>
						<div class="product-item-info-container product-item-price-container" id="<?=$itemIds['PROP_DIV']?>">
							<?
